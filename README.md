...
Coloque ambos os recursos em: resources/[local]/ No seu server.cfg, adicione:

ensure Painel-Mecanico-Fivem

ensure Fivem-Mechanicshop

📌 Sobre o Sistema Este script é responsável pela loja da mecânica
...
ficou estranho me mande arquvio com formattção do texto bonita pra eu baixar e colocar 
